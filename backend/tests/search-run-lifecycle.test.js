...
test('runs still "running" from before this backend started are marked failed', () => {
  ...
  db.prepare(`INSERT INTO search_runs (id, query, status, created_at) VALUES (1, 'old', 'running', '2026-01-01 00:00:00')`).run()
  db.prepare(`INSERT INTO search_runs (id, query, status, created_at) VALUES (2, 'new', 'running', '2026-12-31 00:00:00')`).run()
  db.prepare(`INSERT INTO search_runs (id, query, status, created_at) VALUES (3, 'done', 'done', '2026-01-01 00:00:00')`).run()
